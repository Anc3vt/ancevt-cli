 ...
 * {@link com.ancevt.replines.core.argument.Arguments}.
 *
 * <h2>Purpose</h2>
 ...
 * }
 *
 * Arguments args = Arguments.parse("--port 8080");
 ...
 * }
 *
 * Arguments args = Arguments.parse("--file ./config.yaml");
 * Example ex = ArgumentBinder.convert(args, Example.class);
 *
 ...
 *   <li>{@link com.ancevt.replines.core.argument.reflection.ArgumentBinder}</li>
 *   <li>{@link com.ancevt.replines.core.argument.Arguments}</li>
 * </ul>
 *
...
public interface ArgumentConverter<T> {
     ...
     */
    class NoConverter implements ArgumentConverter<Object> {
        /**
